...
Arbitrary-precision numbers are available with the excellent [Rmpfr](https://cran.r-project.org/web/packages/Rmpfr/vignettes/Rmpfr-pkg.pdf) package. With 120-bits, all the 42 digits of the above number are shown:
