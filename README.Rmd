...
The large factorials and exponents in the series' terms will quickly under/overflow R's 32-bit floats (range: 1.4e-45 to 3e38). We will be using arbitrary-precision arithmetic from the `Rmpfr` package.
